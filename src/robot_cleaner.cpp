...
int main(int argc, char **argv)
{
    ...
    // double radians_angular_speed = degrees2radians(angular_speed);
    // std::cout << "radians_angular_speed: " << radians_angular_speed << std::endl;
    // double radians_angle = degrees2radians(angle);
    // std::cout << "radians_angle: " << radians_angle << std::endl;

    // rotate(radians_angular_speed, radians_angle, clockwise);
    // ros::Rate loop_rate(0.5);
    //setting deisred location
